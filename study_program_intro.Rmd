...
a) The courses "Analysis of Spatio-temporal Data" and "Machine Learning for Visual Spatio-Temporal Data" are the default courses to attend within this module. However, you can choose to replace one of these two courses (_either_ "Analysis of Spatio-temporal Data" _or_ "Machine Learning for Visual Spatio-Temporal Data" ) by an eligible (thematically fitting) elective course from our course program (called "Course Spatial Data Science" in the figure above). The offering of elective courses varies from semester to semester, and courses that are eligible as an elective for this module will be shown in the corresponding course overview of the module in the course booking system (see [below](#cms)).
...
```{r,echo=F,out.width="100%",fig.align="center"}
magick::image_draw(magick::image_read("./fig/overview_location_in_GI.png"))
```
