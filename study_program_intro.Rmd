...
- 60 ECTS for courses
- 30 ECTS for your external semester
- 30 ECTS for writing and defending your Master thesis
...
There are three courses eligible for this module. You chose one of these 3 courses to complete this module.
...
b) If you are not studying module 5, you have to choose at least one study project in this module.
...
To receive the ECTS at the end of each semester for the courses you have attended you need to enroll in those courses in the University´s course booking system (QISPOS). You can find it [here](https://studium.uni-muenster.de/qisserver). There is a specific period for enrolling in courses during the start of the semester.
...
As you can see, there are four seminars, one combined lecture/exercise and two study projects ("project course") offered for this module.
...
6) Check the green Courses. These are course involving choices, i.e. elective courses (modules 4 and 6) or courses that can be replaced (modules 2 and 3). Check the corresponding modules in the course booking system to see what (other) choices are available in the current semester.
