...
6) Now check the green Courses. These are course involving choices, i.e. elective courses (modules 4 and 6) or courses that can be replaced (modules 2 and 3). Check the corresponding modules in the course booking system to see what (other) choices are available in the current semester.
